...
describe('getRentReceiptDataFromLease', () => {
    ...
    it('should throw if lease is not found', async () => {
        ...
        await expect(getRentReceiptDataFromLease(1)).rejects.toThrow('Lease not found');
    });
    ...
    it('should throw if user is missing', async () => {
        ...
        await expect(getRentReceiptDataFromLease(1)).rejects.toThrow('Missing tenant information');
    });
    ...
    it('should throw if accommodation is missing', async () => {
        ...
        await expect(getRentReceiptDataFromLease(1)).rejects.toThrow('Missing accommodation');
    });
    ...
    it('should throw if accommodation.owner is missing', async () => {
        ...
        await expect(getRentReceiptDataFromLease(1)).rejects.toThrow('Missing landlord information');
    });
});
